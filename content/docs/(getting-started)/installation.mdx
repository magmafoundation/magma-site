...
1. Visit the [Magma downloads page](https://magmafoundation.org/downloads)
2. Download the installer (e.g., `magma-21.1.29-beta-installer.jar`)
3. Create a new folder for your Magma server

### Option 2: Using the Launcher (For versions 1.40-beta and above)

1. Visit the [Magma downloads page](https://magmafoundation.org/downloads)
2. Look for the orange "Launcher" button for versions 1.40-beta and above
3. Download the launcher JAR file (with the `-launcher.jar` suffix)
4. Create a new folder for your Magma server
...
1. Move the downloaded launcher JAR (e.g., `magma-21.1.29-beta-launcher.jar`) to your server folder
2. Run the launcher directly with:

```bash
java -jar magma-21.1.29-beta-launcher.jar
```

3. The launcher will guide you through the setup process
