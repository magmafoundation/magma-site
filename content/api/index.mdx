...
- [Versions List API](/api/endpoints/versions-list) - Get a list of available Magma versions
- [Version Details API](/api/endpoints/version-details) - Get detailed information about a specific version
- [Download API](/api/endpoints/download) - Direct download of a specific version
- [Latest Version API](/api/endpoints/latest-version) - Get information about the latest version
- [Latest Download API](/api/endpoints/latest-download) - Direct download of the latest version
